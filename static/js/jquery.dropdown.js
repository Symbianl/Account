...
(function ($) {
  ...
  var settings = {
    readonly: false,
    limitCount: Infinity,
    input: '<input type="text" maxLength="20"   placeholder="搜索保险公司">',
    data: [],
    searchable: true,
    searchNoData: '<li style="color:#ddd">公司不存在，请重试</li>',
